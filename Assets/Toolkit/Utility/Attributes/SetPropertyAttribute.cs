...
namespace Toolkit.Utility.Attributes
{
	...
	/// <summary>
	/// 通过获取到属性父对象，使用反射获取对应字段名的 ProperInfo 然后反射赋值
	/// </summary>
	...
	public class SetPropertyDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			else if (setProperty.IsDirty)
			{
				...
				object parent =
					GetParentObjectOfProperty(property.propertyPath, property.serializedObject.targetObject);
		...
		private object GetParentObjectOfProperty(string path, object obj)
		{
			...
			FieldInfo fi = obj.GetType().GetField(fields[0],
