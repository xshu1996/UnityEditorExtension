...
namespace Toolkit.EditorExtension.EditorWindows.Tools
{
    public class MigrationLuaToTxtEditor : EditorWindow
    {
        ...
        {
            MigrationLuaToTxtEditor window =
                (MigrationLuaToTxtEditor)EditorWindow.GetWindow(typeof(MigrationLuaToTxtEditor));
        ...
        private void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                {
                    srcPath = EditorUtility.OpenFolderPanel("Open Lua Scripts Root Directory", Application.dataPath,
                        String.Empty);
                }
            }
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                if (GUILayout.Button("Browse", GUILayout.Width(60f)))
                {
                    dstPath = EditorUtility.OpenFolderPanel("Open Lua Scripts Migration Destination Directory",
                ...
                for (int i = 0; i < row; ++i)
                {
                    ...
                    EditorGUILayout.BeginHorizontal(lineStyle, GUILayout.Height(rowHeight));
                    {
                        ...
                        if (isInView && files.Count > i)
                        {
                            ...
                            // show internal path
                            EditorGUILayout.SelectableLabel(internalName, GUILayout.ExpandWidth(true),
                                GUILayout.Height(20));
